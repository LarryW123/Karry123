...
<html>
  ...
  <body>
    <form action="case/case731/studentDAO.jsp" method="post">
    ...
    StudentDAOimpl studentD = new StudentDAOimpl(DButil.getConnection());
    ...
    //显示
    ArrayList<Student> studentList = studentD.select(student);
